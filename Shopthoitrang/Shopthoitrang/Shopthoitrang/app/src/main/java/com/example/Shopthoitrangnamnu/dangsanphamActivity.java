package com.example.Shopthoitrangnamnu;
...
public class dangsanphamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sanPhamModels != null) {
            edtBh.setText(sanPhamModels.getmausac());
            edtMt.setText(sanPhamModels.getMota());
            edtNsx.setText(sanPhamModels.getkichco());
    ...
    private void initView() {
        ...
        findViewById(R.id.btn_save).setOnClickListener(view -> {
            ...
            try {
                ...
                sp.setkichco(edtNsx.getText().toString());
                ...
                sp.setmausac(edtBh.getText().toString());
